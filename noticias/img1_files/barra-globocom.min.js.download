...
b[c]);if(null!==d&&void 0!==d)for("[object Array]"===Object.prototype.toString.call(d)||(d=[d]),b=d.length-1;0<=b;b--)d[b].nodeName&&d[b].nodeType?a.appendChild(d[b]):a.innerHTML=d[b];return a},getData:function(a,b,d){var c=p;p||(f.barra=f.barra||{},common=f.barra.common,c=common.getDataByMethod);c("GET",a,b,d)},getDataByMethod:p,getPostData:function(a,b,d){var c=p;p||(f.barra=f.barra||{},common=f.barra.common,c=common.getDataByMethod);c("POST",a,b,d)},jsonpGet:function(a,b,d){d=r(r({},y),d);d.c||
(d.p._=(new Date).getTime());var c="",h;for(h in d.p)c+="&"+h+"="+d.p[h];d.m||(d.m="barraJsonp"+(new Date).getTime());a+=-1<a.indexOf("?")?"&":"?";a+="callback="+d.m;var e;window[d.m]=function(a){e=[a]};m(a+c,function(){var a=e?e[0]:null;e=void 0;b.call(d.bind||this,a)},!0)},appendScript:m,appendCss:function(a,b,d){var c=document.createElement("link");c.rel="stylesheet";c.type="text/css";c.id="cssAppended-"+w;c.href=a;w++;n(c,b,d)},addClass:k,removeClass:l,hasClass:q,toggleClass:function(a,b){q(a,
b)?l(a,b):k(a,b)},fireOnDocumentClick:function(a,b){function c(h){for(h=h.target||h.srcElement;h&&h!=a;)h=h.parentNode;h!=a&&(d(document,"click",c),c.ka=!0,b())}setTimeout(function(){h(document,"click",c)},0);return c},clearDocumentClick:function(a){a&&a.ka&&d(document,"click",a)},bindEvent:h,unbindEvent:d,clearAuthArea:function(){var a=v("barra-auth-area");a&&(a.innerHTML="")},preventDefault:function(a){a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},throttle:function(a,b,d){var c,h;b=
b||250;return function(){var e=d||this,q=+new Date,g=arguments;c&&q<c+b?(clearTimeout(h),h=setTimeout(function(){c=q;a.apply(e,g)},b)):(c=q,a.apply(e,g))}},isIE:function(){return/MSIE (6|7|8)/.test(window.navigator.userAgent)},hasSVG:a,isSmall:c,initIScroll:function(){},isOldDevice:function(){return x},isIEMobile:b,replaceHttp:function(a){window.glb.barra.options.isSecure&&(a=a.replace("http://","https://"));return a},addOldDeviceClass:function(){!c()||a()||b()||(x=!0,k(document.documentElement,"glb-device-old"),
document.body.scrollTop+=1)},enableMouseEvents:function(a){"onmouseenter"in document.documentElement||(a.addEventListener("mouseover",function(a){a.relatedTarget&&(a.relatedTarget===this||this.compareDocumentPosition(a.relatedTarget)&Node.DOCUMENT_POSITION_CONTAINED_BY)||this.dispatchEvent(new Event("mouseenter"))},!1),a.addEventListener("mouseout",function(a){a.relatedTarget&&(a.relatedTarget===this||this.compareDocumentPosition(a.relatedTarget)&Node.DOCUMENT_POSITION_CONTAINED_BY)||this.dispatchEvent(new Event("mouseleave"))},
!1))},offset:function(a){for(var b=a.offsetLeft,d=a.offsetTop;a=a.offsetParent;)b+=a.offsetLeft,d+=a.offsetTop;return{left:b,top:d}},isDomainGlobocom:function(){return!!document.location.hostname.match(/.*\.globoi?\.com$/)},getUserAgent:e,isApp:function(){var a=e();return g().test(a)},extractAppFromUserAgent:function(){var a=e().split(" "),b;for(b in a){var d=a[b];if(g().test(d))return a=d.split("/"),{name:a[0].replace("_"," "),version:a[1]}}return null}}})(window.glb=window.glb||{});
